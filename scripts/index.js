...
const formProfileValidator = new FormValidator(input.formProfileSelector, input);
formProfileValidator.enableValidation()

const formNewPlaceValidator = new FormValidator(input.formNewPlaceSelector, input);
